export default function UploaderIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      width="800px"
      height="800px"
      ...
      <g fill="none" fillRule="evenodd" transform="translate(2 3)">
        <g transform="translate(2 3)">
          <mask id="upload-b" fill="#ffffff">
            <use xlinkHref="#upload-a" />
          </mask>
          <use fill="#D8D8D8" fillRule="nonzero" xlinkHref="#upload-a" />
          <g fill="#FFA0A0" mask="url(#upload-b)">
            <rect width="24" height="24" transform="translate(-4 -6)" />
          </g>
        </g>
        <mask id="upload-d" fill="#ffffff">
          <use xlinkHref="#upload-c" />
        </mask>
        <use fill="#000000" fillRule="nonzero" xlinkHref="#upload-c" />
